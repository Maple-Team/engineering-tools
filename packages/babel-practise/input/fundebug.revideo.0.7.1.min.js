...
!(function (e, t) {
  ...
  return (function (n) {
    ...
    function (e, t, n) {
      ...
      document.all ||
        ...
        (document.addEventListener &&
          (r.initConfig(),
          /comp|inter|loaded/.test(document.readyState) ? o() : document.addEventListener('DOMContentLoaded', o)))
    },
    function (e, t, n) {
      'use strict'
      n.r(t),
        n.d(t, _0x347a('0x0'), function () {
          return i
        })
      var r = n(2),
        i = function () {
          ...
          ;(fundebug.domain = t || document.location.origin),
            (fundebug.maxRevideoSizeInByte = fundebug.maxRevideoSizeInByte || e.getAttribute('maxRevideoSizeInByte')),
            fundebug.maxRevideoSizeInByte || (fundebug.maxRevideoSizeInByte = 150)
        }
    },
    function (e, t, n) {
      'use strict'
        ...
        l = function (e, t) {
          ...
          for (
            var n = 0,
              r = 0,
              i = (function (e) {
                for (var t = [0], n = 0, r = 1; r < e.length; )
                  e[n] === e[r]
                    ? ((t[r] = n + 1), (r += 1), (n += 1))
                    : 0 === n
                    ? ((t[r] = 0), (r += 1))
      ...
      var m = (function () {
        function n() {
          !(function (e, t) {
            ...
            (this.revideoVersion = '0.7.1'),
            (this.url = 'http://localhost:3000/summary'),
            (this.MAX_SEQUENCE_FULL_SIZE_BY_LENGTH = 1024 * fundebug.maxRevideoSizeInByte),
            1024e3 < this.MAX_SEQUENCE_FULL_SIZE_BY_LENGTH && (this[_0x347a('0x4')] = 5e5),
            (this.MAX_SINGLE_FRAGMENT_LENGTH = 1e3),
            (this[_0x347a('0x5')] = 2e3),
            (this.MAX_TOTAL_LENGTH = 1e4),
            (this.MAX_TIME_SPAN_PER_FRAGMENT = 20),
          ...
          (t = [
            ...
            },
            {
              ...
              value: function () {
                ...
                e > this.MAX_SEQUENCE_FULL_SIZE_BY_LENGTH &&
                  (1 < this.calculateSequenceLen()
                    ? (this.shiftFragment(), (e = this.calculateSequenceSize()))
                    : (this.sequence = [])),
                  e > this.MAX_SEQUENCE_FULL_SIZE_BY_LENGTH
                    ? (this.sequence = [])
                    : 3e5 < e && 0.3 <= Math.random() && (this.sequence = [])
                var t = []
                try {
              ...
              value: function () {
                return this.sequence.reduce(function (e, t) {
                  var n = t.actions.reduce(function (e, t) {
                    var n = 0
                    return (
                      t.actionData.outerHTML
                        ? (n = t.actionData.outerHTML.length)
                        : t.actionData.redoableElement &&
                          t.actionData.redoableElement.outerHTML &&
                          (n = t.actionData.redoableElement.outerHTML.len),
                      e + n
                    )
                  }, 0)
            ...
            },
            {
              ...
              value: function () {
                if (((this.vedio = null), this.recorder)) this.recorder.restart()
                  ...
                  this.recorder = new a.default({ target: document.documentElement })
                  var e = this
                    ...
                    0 !== s.length &&
                      ...
                      (n = setInterval(function () {
                        0 ===
                          ...
                          })).length && (clearInterval(n), c.inputInterValIds.splice(c[_0x347a('0x9')].indexOf(n), 1)),
                          t.map(function (e) {
                            var t
                            t =
                              e && 'password' === e.type
                ...
                if ((this.redoIntervalId && window.clearInterval(this.redoIntervalId), !this.isStop)) {
                  ...
                  this.redoIntervalId = setInterval(function () {
                    if ((e.timeSpanCount++, 2 <= e.timeSpanCount))
                      return (
                        (e.timeSpanCount = 0),
                        1 < e.calculateSequenceLen() && this.shiftFragment(),
                        void e.pushFragmentToSequence(0)
                      )
                    ;(e[_0x347a('0xa')] && e.vedio.getFramesLength()) + e.actions.length >
                      e.MAX_SINGLE_FRAGMENT_LENGTH && e.pushFragmentToSequence(0)
            ...
            },
            {
              ...
              value: function () {
                ...
                ;(this.calculateTotalLastTime() > this.MAX_TIME_SPAN_PER_FRAGMENT ||
                  (e > this.MAX_TOTAL_FRAGMENT_LENGTH && 1 < this.calculateSequenceLen()) ||
                  e > this[_0x347a('0xc')]) &&
                  this.shiftFragment()
              },
            },
              ...
              value: function () {
                for (var e = [], t = this.sequence[0], n = 1; n < this.sequence.length; n++) {
                  ...
                  if (0 === t.type && t.type === r.type) {
                    ...
                    ;(t.vedio[_0x347a('0xd')] = i.concat(r[_0x347a('0xa')].frames)),
                      (t.actions = t.actions.concat(r.actions))
                  } else e.push(t), (t = r)
                }
    ...
    function (e, t) {
      ...
      if (
        ('undefined' != typeof WebKitMutationObserver
          ...
          : document.all || (n = MutationObserver),
        void 0 === n)
      )
        throw Error('MutationObserver is undefined')
      var d,
        i,
        u = (function () {
          function n() {
          ...
          return (
            (n.prototype.isIndex = function (e) {
              return +e == e >>> 0
            }),
            ...
            (n.ID_PROP = '__mutation_summary_node_map_id__'),
            (n.nextId_ = 1),
            n
          )
        })()
      ...
      var o = (function () {
          ...
          return (
            (e.prototype.getAttributeOldValue = function (e) {
              if (this.attributeOldValues)
                return this[_0x347a('0x11')] && (e = e[_0x347a('0x12')]()), this[_0x347a('0x13')][e]
            }),
        ...
        s = (function (a) {
              ...
              switch (r.type) {
                case 'childList':
                  ...
                  for (i = 0; i < r.addedNodes.length; i++)
                    (o = r.addedNodes[i]), this.getChange(o).insertedIntoParent()
                  break
                case 'attributes':
          ...
          return (
            ...
            (e.prototype.getWasReachable = function (e, t) {
              ...
              return (
                void 0 === n && ((n = this.getWasReachable(this.getOldParent(e), t)), this.wasReachableCache.set(e, n)),
                n
              )
            }),
        ...
        c = (function () {
          ...
          return (
            (e[_0x347a('0xf')].processMutations = function () {
            ...
            (e.prototype.visitNode = function (e, t) {
              if (!this.visited.has(e)) {
                ...
                var n = this.treeChanges.get(e),
                  r = t
                if (
                  (((n && n.childList) || null == r) && (r = this.treeChanges.reachabilityChange(e)),
                  r !== d.STAYED_OUT)
                ) {
                  if ((this.matchabilityChange(e), r === d.ENTERED)) this.entered.push(e)
                  else if (r === d.EXITED) this.exited.push(e), this.ensureHasOldPreviousSiblingIfNeeded(e)
                  else if (r === d.STAYED_IN) {
                    var i = d.STAYED_IN
                    n &&
                      n.childList &&
            ...
            (e.prototype.ensureHasOldPreviousSiblingIfNeeded = function (e) {
              if (this.calcOldPreviousSibling) {
                ...
                r || ((r = new a()), this.childListChangeMap.set(t, r)),
                  r.oldPrevious[_0x347a('0x18')](e) || r.oldPrevious.set(e, e.previousSibling)
              }
            }),
            (e.prototype[_0x347a('0x19')] = function (e, t, n) {
              ...
              for (r = 0; r < o.length; r++)
                if (((i = o[r]), (s = this.matchabilityChange(i)) === d[_0x347a('0x1b')])) e.added[_0x347a('0x1c')](i)
              ...
              for (r = 0; r < this.exited.length; r++) {
                var s
                ;(i = this.exited[r]),
                  ((s = this.matchabilityChange(i)) !== d.EXITED && s !== d.STAYED_IN) ||
                    e[_0x347a('0x1d')][_0x347a('0x1c')](i)
              }
            }),
            (e.prototype.getOldParentNode = function (e) {
              ...
              if (n === d.STAYED_OUT || n === d[_0x347a('0x1b')])
              ...
              for (r = 0; r < o[_0x347a('0x1a')]; r++) {
                ...
                if (
                  ...
                  for (var u = a, c = s.getAttributeNamesMutated(), l = 0; l < c.length; l++) {
                    var h = c[l]
                    ;(!t || t[h] || (s.isCaseInsensitive && n[h])) &&
                      s.getAttributeOldValue(h) !== u.getAttribute(h) &&
                      (n && s.isCaseInsensitive && (h = n[h]), (i[h] = i[h] || []), i[h].push(u))
                  }
              }
              return i
            }),
            ...
            (e.prototype.matchabilityChange = function (e) {
              ...
              for (
                var n = e,
                  r = this.selectors.map(function (e) {
                    return t.computeMatchabilityChange(e, n)
                  }),
                  i = d.STAYED_OUT,
                  o = 0;
                i !== d.STAYED_IN && o < r.length;
              ...
              if (!this.childListChangeMap) {
                ...
                for (var e = 0; e < this[_0x347a('0x20')].length; e++) {
                  ...
                  if (
                    ...
                    for (
                      var n = this.getChildlistChange(t.target), r = t.previousSibling, i = 0;
                      i < t.removedNodes.length;
                      i++
                    )
                      a((o = t.removedNodes[i]), r),
                        n.added.has(o) ? n.added.delete(o) : (n.removed.set(o, !0), n.maybeMoved.delete(o)),
                        (r = o)
            ...
            (e.prototype.wasReordered = function (e) {
              ...
              var a = new u(),
                s = new u()
              return (
                i.maybeMoved.keys().forEach(function r(e) {
                  if (!e) return !1
        ...
        l = (function () {
          function e(e, t) {
            ...
            if (
              ...
              (this.added = []),
              (this.removed = []),
              (this[_0x347a('0x22')] = t.all || t.element || t.characterData ? [] : void 0),
      ...
      var g = (function () {
          ...
          return (
            ...
            (e.prototype.toString = function () {
              return _0x347a('0x27') === this.attrName && this.contains
                ? '.' + this.attrValue
          ...
          return (
            ...
            (f.prototype[_0x347a('0x28')] = function (e, t, n) {
              ...
              for (a = 0; a < this.qualifiers.length; a++)
                if (
                  ((s = this.qualifiers[a]), void 0 === (u = i[a]) && (u = e.getAttribute(s.attrName)), !s.matches(u))
                )
                  return !1
              return !0
            }),
            ...
            (f.parseSelectors = function (e) {
              ...
              for (
                var a, s = /\s/, u = 'Invalid or unsupported selector syntax.', c = 1, l = 0;
                l < e[_0x347a('0x1a')];
            ...
            (f.matchesSelector =
              'function' == typeof (e = document.createElement('div')).webkitMatchesSelector
                ...
                : 'function' == typeof e[_0x347a('0x2c')]
                ? 'mozMatchesSelector'
      ...
      function y(e) {
        ...
        for (var t = {}, n = {}, r = e[_0x347a('0x2d')](/\s+/), i = 0; i < r.length; i++)
          if ((o = r[i])) {
            var o,
              a = (o = b(o)).toLowerCase()
            if (t[a])
      ...
      var x = (function () {
        function s(e) {
          ...
          ;(this.connected = !1),
            ...
            (this.elementFilter = Array.prototype.concat.apply(
              [],
              this.options[_0x347a('0x2e')].map(function (e) {
            ...
            s.createQueryValidator &&
              (this.queryValidators = this.options.queries[_0x347a('0x2f')](function (e) {
        ...
        return (
          ...
          (s.validateOptions = function (e) {
            ...
            if (!e.queries || !e.queries[_0x347a('0x1a')])
            ...
            for (
              ...
              if (i.all) {
                ...
                n.queries[_0x347a('0x1c')]({ all: !0 })
              } else if ('attribute' in i) {
                if (
                  (((a = { attribute: b(i.attribute) }).elementFilter = f.parseSelectors('*[' + a.attribute + ']')),
                ...
                var o = Object.keys(i).length,
                  a = { element: i.element, elementFilter: f.parseSelectors(i.element) }
                if ((i.hasOwnProperty('elementAttributes') && ((a.attributeList = y(i.elementAttributes)), o--), 1 < o))
                  throw Error('Invalid request option. element only allows elementAttributes option.')
                n.queries.push(a)
              } else {
                if (!i.characterData) throw Error('Invalid request option. Unknown query request.')
                if (1 < Object.keys(i)[_0x347a('0x1a')])
          ...
          (s.prototype.createSummaries = function (e) {
            ...
            for (
              var t = new c(this.root, e, this.elementFilter, this.calcReordered, this.options.oldPreviousSibling),
                n = [],
                r = 0;
              r < this.options.queries.length;
              r++
            )
              n.push(new l(t, this.options.queries[r]))
            return n
          }),
          ...
          (s.prototype.changesToReport = function (e) {
            return e.some(function (t) {
              return (
                !!['added', 'removed', 'reordered', 'reparented', 'valueChanged', 'characterDataChanged'].some(
                  function (e) {
          ...
          (s.NodeMap = u),
          (s[_0x347a('0x32')] = f.parseSelectors),
          (s[_0x347a('0x33')] = {
            callback: !0,
            queries: !0,
            rootNode: !0,
          ...
          return e
            .map(function (e) {
              ...
              i = (function (e) {
                ...
                for (var n = 0; n < t; n++)
                  if (!e[n].isSmallContent) {
                    var r = 0
                    e: for (var i = n + 1; i < t; i++)
                ...
                for (var s = [], u = 0; u < t; u++)
                  e[u].isSmallContent || s.push(e[u]), delete e[u].isSmallContent, delete e[u][_0x347a('0x36')]
                return s
              })(i)
              var o,
                a,
        ...
        return (function (o) {
          ...
          o.map(function (e, t) {
            if (0 !== t) {
              ...
              r !== i && n !== i
                ? n && -1 != n.indexOf(i)
                  ? (e.isSmallContent = !0)
                  : (i && -1 != i.indexOf(n) && (o[a].isSmallContent = !0), (a = t))
                : (a = t)
            }
          }),
          ...
          for (var t = 0; t < e; t++)
            if (!o[t].isSmallContent) {
              var n = 0
              e: for (var r = t + 1; r < e; r++)
                if (!o[r].isSmallContent) {
                  var i = o[t][_0x347a('0x36')],
                    s = o[r].funContent
                  if (i !== s) {
                    if (i && -1 != i.indexOf(s)) o[r].isSmallContent = !0
      ...
      var i = (function () {
        function s(e, t, n, r) {
          !(function (e, t) {
            ...
            (0 !== e && 3 !== e) || (this.outerHTML = t.outerHTML || t.textContent)
    ...
    function (e, t, n) {
      'use strict'
      n.r(t),
        n.d(t, 'calculatePinpoint', function () {
          return i
        }),
        ...
        r = function (e, t, n) {
          return {
            ...
            localSelector: (function (e, t, n) {
              ...
              if (
                (e.funId || (e.funId = f.uniqueID()),
                n.push(e.funId, { funLocalSelector: e[_0x347a('0x3b')], index: r }),
                s <= r)
              )
      ...
      function d(e, t, n, r) {
        return (
          (e.previousElementSibling = t.previousElementSibling), (e[_0x347a('0x3c')] = t.previousSibling), u(e, n, r)
        )
      }
      function c(e) {
      ...
      function p(e, t) {
        ...
        if (
          (e.funId || (e.funId = f.uniqueID()),
          t.push(e[_0x347a('0x3d')], { funLocalSelector: e.funLocalSelector, index: n }),
          s <= n)
        )
          throw new Error('too deep for calculateElementLocalSelector')
      ...
      function l(e, t, n, r) {
        ...
        return (
          a && (i += l(a, t, ++n, r)),
          m(e.funLocalSelector, t) && (r.push(e.funId, { funLocalSelector: e.funLocalSelector, index: i }), i++),
          i
        )
      }
      function g(e) {
          ...
          return (
            ...
            (e =
              !n || ('object' !== l(n) && 'function' != typeof n)
                ...
                : n)).events = ['mousemove', 'click', 'scroll', 'resize']),
            (e.eventHandlers = []),
            (e.vedio = null),
            (e.isRecording = !1),
            (e.mousemoveSamplingFrequence = 0),
            (e.MaxMousemoveSamplingFrequence = 5),
            e.target instanceof window.HTMLHtmlElement && (e.listeners = { scroll: window, resize: window }),
          ...
          (n = [
              ...
              value: function () {
                ...
                for (
                  var e = function (e) {
                      ...
                      i.eventHandlers.splice(e, 0, r),
                        _0x347a('0x43') === t
                          ? i.getListener(t).addEventListener(t, r, !0)
                          : i.getListener(t).addEventListener(t, r)
                    },
                    t = 0;
            ...
            },
            {
              ...
              value: function () {
                ...
                ;(i = '<!DOCTYPE html>' + i),
                  (n.scene = i),
                  (n.rootOpts = { style: e.getAttribute('style'), class: e[_0x347a('0x44')]('class') }),
                  (n.scrollX = e.scrollLeft),
            ...
            },
            {
              ...
              value: function (e, t, n) {
                if ('mousemove' === n.type) {
                  if (!(e[_0x347a('0x46')] >= e.MaxMousemoveSamplingFrequence))
                ...
                try {
                  for (
                    var e = new DOMParser().parseFromString(t, 'text/html'),
                      n = e.getElementsByClassName('_fun-hide'),
                      r = [][_0x347a('0x49')].call(n),
                      i = 0;
                    i < r.length;
                    i++
                  )
          ...
          return (
            ...
            (e =
              ...
              ('object' !== a(n) && 'function' != typeof n)
                ...
                : n),
            i[_0x347a('0x4b')] ? e.setTarget(i.target) : (e.target = null),
            (e.onEvents = i.onEvents || e.onEvents()),
            e
          )
        }
        return (
    ...
    function (e, t, n) {
      ...
      function c(e, t, n, r) {
        ...
        if (
          ...
          0 < (i = u(e)) && a.length > i && !a.warned)
        ) {
          a.warned = !0
          var s = new Error(
            'Possible EventEmitter memory leak detected. ' + a.length + ' ' + String(t) + _0x347a('0x4c')
          )
          ;(s.name = 'MaxListenersExceededWarning'),
            (s.emitter = e),
            (s.type = t),
            (s.count = a.length),
            console && console[_0x347a('0x4d')]
        }
        return e
      }
      function h(e, t, n) {
        var r = { fired: !1, wrapFn: void 0, target: e, type: t, listener: n },
          i = function () {
            ...
            this.fired ||
              (this.target.removeListener(this.type, this.wrapFn), (this.fired = !0), l(this.listener, this.target, e))
          }.bind(r)
      ...
      Object.defineProperty(a, _0x347a('0x4e'), {
        ...
        (a.prototype.emit = function (e) {
          ...
          var r = _0x347a('0x50') === e,
            i = this._events
          if (void 0 !== i) r = r && void 0 === i[_0x347a('0x50')]
          else if (!r) return !1
          if (r) {
            var o
    ...
    function (e, t, n) {
      ...
      function o(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          ;(r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            _0x347a('0x52') in r && (r.writable = !0),
            Object.defineProperty(e, r.key, r)
        }
      }
      var r = (function () {
      ...
      var i = (function () {
        function n() {
          ...
          !(function (e, t) {
            ...
            (this[_0x347a('0x57')] = e.selfSelector || null)
        }
        return (
          r(n.prototype, [
            {
        ...
        i = (function () {
          ...
          var a = {
            ...
            decompressFromUint8Array: function (e) {
              ...
              for (var t = new Array(e.length / 2), n = 0, r = t[_0x347a('0x1a')]; n < r; n++)
                  ...
                  if (Object.prototype.hasOwnProperty.call(s, l)) {
                    if (l.charCodeAt(0) < 256) {
                      ...
                      for (i = l.charCodeAt(0), r = 0; r < 8; r++)
                        (p = (p << 1) | (1 & i)), g == t - 1 ? ((g = 0), v.push(n(p)), (p = 0)) : g++, (i >>= 1)
                    } else {
                      for (i = 1, r = 0; r < d; r++)
                        (p = (p << 1) | i), g == t - 1 ? ((g = 0), v.push(n(p)), (p = 0)) : g++, (i = 0)
            ...
            _decompress: function (e, t, n) {
              ...
              for (o = 0, s = Math.pow(2, 2), u = 1; u != s; )
                (a = g.val & g.position),
                  (g.position >>= 1),
                  0 == g.position && ((g.position = t), (g[_0x347a('0x5d')] = n(g.index++))),
                  (o |= (0 < a ? 1 : 0) * u),
                  (u <<= 1)
              switch (o) {
                case 0:
              ...
              for (i = l[3] = c, p.push(c); ; ) {
                ...
                if ((0 == h && ((h = Math.pow(2, d)), d++), l[c])) v = l[c]
                else {
                  if (c !== f) return null
                  v = i + i.charAt(0)
                }
