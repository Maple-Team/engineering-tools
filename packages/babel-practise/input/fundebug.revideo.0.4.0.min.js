...
!(function (e, t) {
  ...
  return (function (r) {
          ...
          n(r, [
            ...
            },
            {
              ...
              value: function () {
                ...
                var e = [];
                try {
                  (e = JSON[_0x4475("0x1")](this.sequence)), JSON.parse(e);
                } catch (e) {
                  this.sequence;
                }
                var t = "";
                try {
                  t = l.default.isSafariOrWKWebview()
                    ? c.default.compressToBase64(e)
                    : c.default.compress(e);
                } catch (e) {}
                return {
            ...
            },
            {
              key: "initRecorder",
              value: function () {
                if (((this.vedio = null), this.recorder))
            ...
            },
            {
              key: "initAction",
              value: function () {
                (this.actions = []), this[_0x4475("0x2")](), this.initInput();
              },
            },
            {
              key: "initMutationObserver",
              value: function () {
                this[_0x4475("0x3")] && this.observer.disconnect();
                var r = this;
                try {
                ...
                ["input", "textarea", "select"].map(function (e) {
                  function n(e, t, r, n) {
                    ...
                    if (0 < i) {
                      ...
                      if (
                        4 === o.getActionType() &&
                        o.getActionData().getInput().getValue() === r
                      )
                        return;
                    }
                    var a = new h.default(t, e[_0x4475("0x4")], r),
                      s = new p.default(),
                      u = new p.default(),
                        ...
                        (r = setInterval(function () {
                          0 ===
                            (t = t.filter(function (e) {
                              return (
                                e[_0x4475("0x6")] && delete o[e.funId],
                                !e.funRemoved
                              );
                            ...
                            t.map(function (e) {
                              ...
                              } else (e.funId = l[_0x4475("0x7")].uniqueID()), (o[e.funId] = t), n(e, i, t, c);
                            });
                        }, 100));
                  }
                });
            ...
            },
            {
              ...
              value: function (e) {
                var r = this;
                e[_0x4475("0x8")](function (e) {
                  var t = o.default.extractCleanNodes(e.added);
                  (e[_0x4475("0x9")] = t).map(function (e) {
              ...
              value: function () {
                ...
                this.redoIntervalId = setInterval(function () {
                  if ((e.timeSpanCount++, 2 <= e.timeSpanCount))
                    return (
                      (e.timeSpanCount = 0),
                      1 < e[_0x4475("0xa")].length && e.sequence.shift(),
                      void e[_0x4475("0xb")](0)
                    );
                  (e.vedio && e.vedio.getFramesLength()) + e.actions.length >
                    e[_0x4475("0xc")] && e.pushFragmentToSequence(0);
            ...
            },
            {
              ...
              value: function () {
                ...
                e > this.multipleFragmentMaxLength &&
                  (1 < this[_0x4475("0xd")]() || e > this.MAXESTLENGTH) &&
                  this.sequence.shift();
              },
            },
            {
        ...
        u = (function () {
          ...
          return (
            ...
            (r.prototype.set = function (e, t) {
              var r = this.nodeId(e);
              (this[_0x4475("0xe")][r] = e), (this.values[r] = t);
            }),
            (r.prototype.get = function (e) {
              var t = this.nodeId(e);
              return this.values[t];
            }),
            (r[_0x4475("0xf")].has = function (e) {
          ...
          function e(e, t, r, n, i, o, a, s) {
            void 0 === t && (t = !1),
              ...
              (this.isCaseInsensitive =
                this[_0x4475("0x10")].nodeType === Node.ELEMENT_NODE &&
                this.node instanceof HTMLElement &&
                this.node.ownerDocument instanceof HTMLDocument);
          }
          return (
            (e.prototype.getAttributeOldValue = function (e) {
              if (this[_0x4475("0x11")])
                return (
        ...
        s = (function (a) {
            ...
            for (var r = 0; r < t.length; r++) {
              ...
              switch (n.type) {
                case "childList":
                  ...
                  for (var i = 0; i < n[_0x4475("0x12")].length; i++) {
                ...
                case "attributes":
                  (this.anyAttributesChanged = !0),
                    this.getChange(n.target).attributeMutated(
                      n.attributeName,
                      n.oldValue
                    );
                  break;
          ...
          return (
            ...
            (e.prototype.getWasReachable = function (e, t) {
              ...
              return (
                void 0 === r &&
                  ((r = this.getWasReachable(this.getOldParent(e), t)),
          ...
          return (
            ...
            (e.prototype.visitNode = function (e, t) {
              if (!this.visited.has(e)) {
                ...
                var r = this.treeChanges.get(e),
                  n = t;
                if (
                  (((r && r.childList) || null == n) &&
                    (n = this.treeChanges.reachabilityChange(e)),
                  n !== d.STAYED_OUT)
                ) {
            ...
            (e.prototype.getChanged = function (e, t, r) {
              ...
              for (var n = 0; n < this.entered.length; n++) {
                ...
                ((s = this.matchabilityChange(i)) !== d.ENTERED &&
                  s !== d.STAYED_IN) ||
                  e.added.push(i);
              }
              ...
              for (n = 0; n < o.length; n++) {
                i = o[n];
                if ((s = this.matchabilityChange(i)) === d.ENTERED)
                  e.added.push(i);
              ...
              for (n = 0; n < this.exited.length; n++) {
                var s;
                i = this.exited[n];
                ((s = this.matchabilityChange(i)) !== d.EXITED &&
                  s !== d.STAYED_IN) ||
                  e.removed.push(i);
              }
            }),
            (e.prototype.getOldParentNode = function (e) {
              ...
              return e[_0x4475("0x15")];
            }),
            (e.prototype[_0x4475("0x16")] = function (e) {
              var t = e.parentNode,
                r = this.treeChanges.get(e);
              r && r.oldParentNode && (t = r.oldParentNode);
              var n = this[_0x4475("0x17")].get(t);
              if (!n)
                throw Error("getOldPreviousSibling requested on invalid node.");
              return n.oldPrevious.get(e);
            }),
            (e.prototype.getOldAttribute = function (e, t) {
              var r = this[_0x4475("0x18")][_0x4475("0x19")](e);
              if (!r || !r.attributes)
            ...
            (e.prototype.attributeChangedNodes = function (e) {
              ...
              for (n = 0; n < o.length; n++) {
                ...
                if (
                  ...
                  for (
                    var u = a, c = s.getAttributeNamesMutated(), l = 0;
                    l < c.length;
                    l++
                  ) {
                    var h = c[l];
                    if (!t || t[h] || (s.isCaseInsensitive && r[h]))
                      s.getAttributeOldValue(h) !== u[_0x4475("0x1a")](h) &&
                        (r && s.isCaseInsensitive && (h = r[h]),
                        (i[h] = i[h] || []),
                        i[h].push(u));
                  }
              }
            ...
            (e.prototype.getCharacterDataChanged = function () {
              ...
              for (
                ...
                if (d.STAYED_IN === this.treeChanges.reachabilityChange(n)) {
                  var i = this.treeChanges[_0x4475("0x19")](n);
                  i.characterData &&
            ...
            (e.prototype.matchabilityChange = function (e) {
              ...
              for (
                var r = e,
                  n = this.selectors[_0x4475("0x8")](function (e) {
            ...
            (e.prototype.processChildlistChanges = function () {
              if (!this.childListChangeMap) {
                ...
                for (var e = 0; e < this.mutations.length; e++) {
                  ...
                  if (
                    "childList" == t.type &&
                    (this.treeChanges.reachabilityChange(t.target) ===
                      d.STAYED_IN ||
                      this.calcOldPreviousSibling)
                  ) {
                    for (
                      var r = this.getChildlistChange(t.target),
                        n = t.previousSibling,
                        i = 0;
                      ...
                      a((o = t.removedNodes[i]), n),
                        r.added.has(o)
                          ? r.added.delete(o)
                          : (r.removed.set(o, !0), r.maybeMoved.delete(o)),
                        (n = o);
                    }
                    a(t.nextSibling, n);
                    for (i = 0; i < t.addedNodes.length; i++) {
                      ...
                      r.removed.has(o)
                        ? (r.removed.delete(o), r.maybeMoved.set(o, !0))
                        : r[_0x4475("0x9")].set(o, !0);
                    }
                  }
                  function a(e, t) {
                    !e ||
            ...
            (e.prototype.wasReordered = function (e) {
              ...
              var t = e.parentNode,
                r = this.treeChanges.get(e);
              r && r.oldParentNode && (t = r[_0x4475("0x1b")]);
              var n = this.childListChangeMap.get(t);
              if (!n) return !1;
                  ...
                  void 0 !== t ||
                    (i.has(e)
                      ...
                      : (i.set(e, !0),
                        (t =
                          (function (e) {
                            if (s[_0x4475("0x1d")](e)) return s.get(e);
                            var t = e.previousSibling;
                            for (; t && (n.added.has(t) || o(t)); )
                              t = t.previousSibling;
                            return s.set(e, t), t;
                          })(e) !==
                          (function e(t) {
          ...
          return (
            ...
            (f.prototype.wasMatching = function (e, t, r) {
              ...
              for (a = 0; a < this.qualifiers.length; a++) {
                s = this.qualifiers[a];
                if (
                  (void 0 === (u = i[a]) && (u = e.getAttribute(s.attrName)),
                  !s.matches(u))
                )
                  return !1;
              }
            ...
            (f.parseSelectors = function (e) {
              var t,
                ...
                n = [];
              function i() {
                t && (r && (t.qualifiers.push(r), (r = void 0)), n.push(t)),
                  (t = new f());
              }
              function o() {
      ...
      var x = (function () {
        function s(e) {
          ...
          (this.connected = !1),
            ...
            (this.observerOptions = s.createObserverOptions(
              this.options.queries
            )),
            (this.root = this.options.rootNode),
            (this.callback = this[_0x4475("0x22")].callback),
            ...
            this[_0x4475("0x23")].length || (this.elementFilter = void 0),
            (this.calcReordered = this.options.queries.some(function (e) {
              return e[_0x4475("0x24")];
            })),
        ...
        return (
          ...
          (s.validateOptions = function (e) {
            for (var t in e)
              if (!(t in s.optionKeys)) throw Error("Invalid option: " + t);
            if ("function" != typeof e.callback) throw Error(_0x4475("0x26"));
            ...
            for (
              ...
              if (i.all) {
                ...
                if (
                  (((a = { attribute: b(i.attribute) }).elementFilter =
                    f.parseSelectors("*[" + a.attribute + "]")),
                  1 < Object.keys(i)[_0x4475("0x27")])
                )
                  throw Error(
          ...
          (s.prototype[_0x4475("0x29")] = function (e) {
            return e.some(function (t) {
              ...
              if (
                t.attributeChanged &&
                Object[_0x4475("0x2a")](t.attributeChanged).some(function (e) {
          ...
          (s.prototype.observerCallback = function (e) {
            ...
            if (
              ...
              !this[_0x4475("0x22")].observeOwnChanges && this.connected)
            ) {
              this.checkpointQueryValidators();
              try {
          ...
          (s.prototype.takeSummaries = function () {
            ...
            return this[_0x4475("0x29")](e) ? e : void 0;
          }),
    ...
    function (e, t, r) {
      ...
      function i(e) {
        return (e = (function (o) {
          ...
          o.map(function (e, t) {
            if (0 !== t) {
              ...
              n !== i && r !== i
                ? r && -1 != r.indexOf(i)
                  ? (e.isSmallContent = !0)
                  : (i && -1 != i.indexOf(r) && (o[a].isSmallContent = !0),
                    (a = t))
                : (a = t);
            }
          }),
          ...
          for (var u = [], c = 0; c < e; c++)
            o[c].isSmallContent || u.push(o[c]), (o[c].isSmallContent = !1);
          return u;
        })(e));
      }
      function y(n, e, t) {
            ...
            (function (e, t, r) {
              ...
              for (; 0 < r.length; ) {
                ...
                if (s.getPinpoint() || 0 !== t) {
                  ...
                  (r = b(c, r)), (r = [c].concat(r)), o[_0x4475("0x2b")](l);
                }
              }
              1 === t && o.reverse();
              return o;
              ...
              e.map(function (e) {
                3 === e.actionData.nodeType
                  ...
                  : (e.funContent = e.actionData.selfSelector
                      ? e.actionData.selfSelector.parentSelector +
                        " > " +
                        e.actionData[_0x4475("0x2e")].localSelector
                      : "No-SelfSelector");
              });
              for (var r = 0; r < t; r++)
                if (!e[r][_0x4475("0x2f")]) {
                  ...
                  e: for (var i = r + 1; i < t; i++)
                    if (!e[i].isSmallContent) {
                      var o = e[r].funContent,
                        a = e[i].funContent;
                      if ("No-SelfSelector" === o || "No-SelfSelector" === a)
                        break e;
                      if (o && 0 === o.indexOf(a)) {
                      ...
                      if (
                        (a && 0 === a.indexOf(o) && (e[i].isSmallContent = !0),
                        300 < ++n)
                      )
                        break e;
                    }
                    ...
                    var e = r[i],
                      t = e.map(function (e) {
                        var t = new p.default(2, e, o, a),
                          r = (function (e, t) {
                            for (
                              var r = t.attributes, n = "", i = r.length, o = 0;
                              o < i;
                              o++
                            ) {
                              var a = r[o];
    ...
    function (e, t) {
      ...
      (e.exports.isEmptyObject = function (e) {
        ...
        (e.exports.extractNodeName = function (e) {
          return e && e.nodeName ? e[_0x4475("0x30")].toLowerCase() : null;
        }),
        ...
        (e.exports.isSafariOrWKWebview = function () {
          return (
            r() ||
            ((e = !1),
            "iP" === navigator.platform.substr(0, 2) &&
              window.webkit &&
    ...
    function (e, t, r) {
      "use strict";
      Object[_0x4475("0x31")](t, _0x4475("0x32"), { value: !0 });
      var n,
        i = (function () {
          function n(e, t) {
            for (var r = 0; r < t.length; r++) {
    ...
    function (e, t, r) {
      ...
      var s = 1e4,
        ...
        a = function (e, t, r, n) {
          return (
            (e.nextElementSibling = t.nextElementSibling),
      ...
      function p(e, t, r, n) {
        return (
          (e.previousElementSibling = t.previousElementSibling),
      ...
      function v(e, t, r) {
        ...
        var n = e.funId;
        if (n) {
          if (t.hasId(n)) return t[_0x4475("0x34")](n);
      ...
      function g(e, t) {
        ...
        if (
          ...
          t.push(e.funId, { funLocalSelector: e.funLocalSelector, index: r }),
          s <= r)
        )
      ...
      function y(e) {
        if (!e) return e;
        var t = e.previousSibling || e[_0x4475("0x35")];
    ...
    function (e, t) {
      ...
      var n = (function () {
        function n(e, t, r) {
          !(function (e, t) {
            if (!(e instanceof t)) throw new TypeError(_0x4475("0x37"));
          })(this, n),
            (this.type = t),
            (this.selector = e),
            5 === t && (this.textNode = r);
          ...
          r(n, [
            {
              ...
              value: function () {
                this.type,
                  console[_0x4475("0x33")]("selector:", this.selector),
        ...
        return (
          n(r, [
            ...
            },
            {
              key: "show",
              value: function () {
                _0x4475("0x39"), this.name, this.value;
              },
            },
          ]),
          r
    ...
    function (e, t) {
      ...
      var n = (function () {
        ...
        return function (e, t, r) {
          return t && n(e[_0x4475("0xf")], t), r && n(e, r), e;
        };
      })();
      var r = (function () {
        function r(e, t) {
        ...
        return (
          n(r, [
            ...
            },
            {
              key: "appendAttribute",
              value: function (e) {
                this.changedAttributeList = this.changedAttributeList.concat([
                  e,
                ]);
              },
            },
      ...
      var r = (function () {
        function n(e, t) {
          for (var r = 0; r < t.length; r++) {
            ...
            (n.enumerable = n.enumerable || !1),
              (n.configurable = !0),
              _0x4475("0x3b") in n && (n.writable = !0),
              Object.defineProperty(e, n.key, n);
          }
        }
        return function (e, t, r) {
    ...
    function (e, t, r) {
      ...
      var n,
        i = (function () {
          function n(e, t) {
            for (var r = 0; r < t[_0x4475("0x27")]; r++) {
              var n = t[r];
              (n.enumerable = n.enumerable || !1),
                (n.configurable = !0),
                "value" in n && (n.writable = !0),
    ...
    function (e, t, r) {
      ...
      var a = (function (e) {
        function r() {
          ...
          return (
            (t.events = ["mousemove", "click", _0x4475("0x3e"), "resize"]),
            (t.eventHandlers = []),
            (t.vedio = null),
            (t.isRecording = !1),
            ...
            t.target instanceof window.HTMLHtmlElement &&
              (t.listeners = { scroll: window, resize: window }),
        ...
        return (
          ...
          n(r, [
            ...
            },
            {
              key: _0x4475("0x3f"),
              value: function () {
                this.init(), this[_0x4475("0x40")]("fun_recording_start");
              },
            },
            {
              key: "start",
              value: function () {
                var i = this;
                this[_0x4475("0x41")](), this.emit("fun_recording_start");
                for (
                  var e = function (e) {
                      var t = i[_0x4475("0x42")][e],
                        r = i.onEvents[t];
                      r || (r = i.defaultEventCallback);
                      var n = function (e) {
                        i.onEventCallback(r, e);
                      };
                      i.eventHandlers[_0x4475("0x43")](e, 0, n),
                        "scroll" === t
            ...
            },
            {
              ...
              value: function () {
                var e = this.getTarget(),
                  ...
                  r = new s.default();
                (r[_0x4475("0x44")] = t.top), (r.left = t.left);
                var n = e[_0x4475("0x45")],
                ...
                return (
                  (r.width = o), (r.height = a), (this.vedio = r), this.vedio
                );
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e, t, r) {
                if ("mousemove" === r.type) {
                  if (
                    !(
                      e.mousemoveSamplingFrequence >=
                      e.MaxMousemoveSamplingFrequence
                    )
                  )
                ...
                var n = r.target,
                  ...
                  o = {
                    scrollY: i
                      ? i.parentNode.scrollTop || i.scrollTop
                      : n.scrollTop,
                    scrollX: i
                      ? i.parentNode.scrollLeft || i[_0x4475("0x46")]
                      : n.scrollLeft,
                    cursorX: r.pageX,
                    cursorY: r.pageY,
                ...
                if ("scroll" === r.type) {
                  ...
                  try {
                    o.selfSelector = c.default.calculateSelfSelector(
                      a,
                      new l.default(),
                      new l[_0x4475("0x7")]()
                    );
    ...
    function (e, t, r) {
      ...
      var o = (function (e) {
        function r() {
          ...
          return (
            e.target ? t.setTarget(e.target) : (t.target = null),
            (t.onEvents = e.onEvents || t.onEvents()),
            t
          );
        }
        return (
          (function (e, t) {
            ...
            (e[_0x4475("0xf")] = Object.create(t && t.prototype, {
              constructor: {
                value: e,
                enumerable: !1,
                writable: !0,
    ...
    function (e, t) {
      function n() {
        (this._events = this[_0x4475("0x48")] || {}),
      ...
      (((e.exports = n).EventEmitter = n).prototype._events = void 0),
        ...
        (n.prototype.emit = function (e) {
          ...
          if (
            ...
            "error" === e &&
              (!this._events.error ||
                (c(this._events.error) &&
                  !this._events.error[_0x4475("0x27")])))
          ) {
          ...
          if (u(r))
            switch (arguments.length) {
              ...
              case 3:
                ...
                break;
              default:
                (i = Array.prototype.slice[_0x4475("0x49")](arguments, 1)),
                  r.apply(this, i);
            }
          else if (c(r))
            for (
        ...
        (n.prototype[_0x4475("0x4a")] = function (e, t) {
          var r, n, i, o;
          if (!u(t)) throw TypeError("listener must be a function");
          ...
          if (
            ...
            delete this._events[e],
              this._events.removeListener &&
                this[_0x4475("0x40")]("removeListener", e, t);
          else if (c(r)) {
            for (o = i; 0 < o--; )
              if (
                r[o] === t ||
                (r[o][_0x4475("0x4b")] && r[o].listener === t)
              ) {
                n = o;
                break;
              }
        ...
        (n.prototype.removeAllListeners = function (e) {
          ...
          if (u((r = this._events[e]))) this.removeListener(e, r);
            ...
            for (; r.length; ) this[_0x4475("0x4a")](e, r[r.length - 1]);
    ...
    function (e, t, r) {
      "use strict";
      Object[_0x4475("0x31")](t, "__esModule", { value: !0 });
      var n,
        i =
          ...
          o(n, [
            ...
            },
            {
              ...
              value: function () {
                return (
                  this[_0x4475("0x4e")] ||
                    (this.sceneDecoded = u.Base64.decode(this.scene)),
                  this.sceneDecoded
                );
              },
            },
        ...
        (t =
          ...
          (r = function (t) {
            ...
            var i =
              ...
              f = r
                ? r.from && r.from !== Uint8Array.from
                  ? function (e) {
                      return (
                        e.constructor === r.constructor ? e : r.from(e)
                      ).toString("base64");
                    }
                  : function (e) {
                      return (
                        e.constructor === r.constructor ? e : new r(e)
                      ).toString("base64");
                    }
                : function (e) {
                    return h(c(e));
              ...
              m = r
                ? r.from && r.from !== Uint8Array.from
                  ...
                  : function (e) {
                      return (
                        e.constructor === r.constructor ? e : new r(e, "base64")
                      ).toString();
                    }
                : function (e) {
                    return g(b(e));
            ...
            return (
              ...
              void 0 !== w && w.exports
                ? (w.exports[_0x4475("0x51")] = t.Base64)
                : void 0 ===
                    (S = function () {
                      return t.Base64;
                    }.apply(_, [])) || (w.exports = S),
    ...
    function (e, B, t) {
      (function (e) {
        ...
        function h(e, t, r) {
          if (!(h[_0x4475("0x53")] || this instanceof h)) return new h(e, t, r);
          if ("number" == typeof e) {
            if ("string" == typeof t)
              throw new Error(
        ...
        function i(e, t, r, n) {
          if (typeof t === _0x4475("0x54"))
            throw new TypeError('"value" argument must not be a number');
          return "undefined" != typeof ArrayBuffer && t instanceof ArrayBuffer
            ? (function (e, t, r, n) {
                if ((t.byteLength, r < 0 || t[_0x4475("0x55")] < r))
        ...
        function c(e, t) {
          if ((u(t), (e = s(e, t < 0 ? 0 : 0 | f(t))), !h.TYPED_ARRAY_SUPPORT))
        ...
        function d(e, t) {
          if (h[_0x4475("0x57")](e)) return e.length;
          if (
            "undefined" != typeof ArrayBuffer &&
            typeof ArrayBuffer.isView === _0x4475("0x58") &&
        ...
        function v(e, t, r, n, i) {
          ...
          throw new TypeError(_0x4475("0x5b"));
        }
        ...
        (B.Buffer = h),
          ...
          h.TYPED_ARRAY_SUPPORT &&
            ((h.prototype.__proto__ = Uint8Array[_0x4475("0xf")]),
          ...
          (h.compare = function (e, t) {
            if (!h.isBuffer(e) || !h.isBuffer(t))
              throw new TypeError(_0x4475("0x56"));
            if (e === t) return 0;
            for (
          ...
          (h.prototype.swap32 = function () {
            var e = this.length;
            if (e % 4 != 0) throw new RangeError(_0x4475("0x59"));
            for (var t = 0; t < e; t += 4)
          ...
          (h.prototype.equals = function (e) {
            if (!h.isBuffer(e)) throw new TypeError(_0x4475("0x5a"));
          ...
          (h[_0x4475("0xf")][_0x4475("0x5c")] = function (e, t, r) {
          ...
          (h.prototype.write = function (e, t, r, n) {
            ...
            for (var o, a, s, u, c, l, h = !1; ; )
              switch (n) {
                ...
                case "utf-8":
                  return (
                    (c = t), (l = r), Y(M(e, (u = this).length - c), u, c, l)
                  );
                case "ascii":
                  return b(this, e, t, r);
                case "latin1":
        ...
        (h.prototype.slice = function (e, t) {
          ...
          if (
            ...
            (r = this[_0x4475("0x5e")](e, t)).__proto__ = h.prototype;
          else {
            var i = t - e;
            r = new h(i, void 0);
          ...
          (h[_0x4475("0xf")].readUInt16BE = function (e, t) {
          ...
          (h.prototype[_0x4475("0x5f")] = function (e, t, r) {
            (e |= 0), (t |= 0), r || T(e, t, this.length);
            for (var n = this[e], i = 1, o = 0; ++o < t && (i *= 256); )
              n += this[e + o] * i;
          ...
          (h.prototype[_0x4475("0x60")] = function (e, t) {
          ...
          (h[_0x4475("0xf")].writeUInt16LE = function (e, t, r) {
            return (
              (e = +e),
              (t |= 0),
          ...
          (h.prototype.writeIntLE = function (e, t, r, n) {
            if (((e = +e), (t |= 0), !n)) {
              var i = Math[_0x4475("0x61")](2, 8 * r - 1);
              O(this, e, t, r, i - 1, -i);
            }
            var o = 0,
              a = 1,
          ...
          (h.prototype.copy = function (e, t, r, n) {
            ...
            n > this[_0x4475("0x27")] && (n = this.length),
        ...
        function q(e) {
          return n.toByteArray(
            (function (e) {
              ...
              if (
                (e = ((t = e),
                t.trim ? t.trim() : t.replace(/^\s+|\s+$/g, "")).replace(D, ""))
                  .length < 2
              )
                return "";
              for (; e.length % 4 != 0; ) e += "=";
    ...
    function (e, t) {
      ...
      (t.byteLength = function (e) {
        ...
        (t.toByteArray = function (e) {
          ...
          var c, l;
          2 === i &&
            ((t = (h[e.charCodeAt(u)] << 2) | (h[e.charCodeAt(u + 1)] >> 4)),
            (o[a++] = 255 & t));
          1 === i &&
            ((t =
              (h[e.charCodeAt(u)] << 10) |
              (h[e.charCodeAt(u + 1)] << 4) |
              (h[e.charCodeAt(u + 2)] >> 2)),
            (o[a++] = (t >> 8) & 255),
            (o[a++] = 255 & t));
          return o;
        }),
        (t.fromByteArray = function (e) {
          for (
            var t, r = e.length, n = r % 3, i = [], o = 0, a = r - n;
            o < a;
            o += 16383
          )
            ...
            t = Math.abs(t),
              isNaN(t) || t === 1 / 0
                ...
                : ((a = Math.floor(Math.log(t) / Math.LN2)),
                  ...
                  2 <= (t += 1 <= a + h ? f / u : f * Math.pow(2, 1 - h)) * u &&
                    (a++, (u /= 2)),
                  l <= a + h
                    ? ((s = 0), (a = l))
                    : 1 <= a + h
        ...
        function n(e, t) {
          for (var r = 0; r < t.length; r++) {
            ...
            (n.enumerable = n.enumerable || !1),
              (n.configurable = !0),
              "value" in n && (n.writable = !0),
              Object.defineProperty(e, n[_0x4475("0x64")], n);
          }
        }
        return function (e, t, r) {
          return t && n(e.prototype, t), r && n(e, r), e;
    ...
    function (e, t, r) {
        ...
        i = (function () {
          ...
          var a = {
            ...
            decompressFromUint8Array: function (e) {
              ...
              for (
                var t = new Array(e.length / 2), r = 0, n = t.length;
                r < n;
                r++
              )
            ...
            _decompress: function (e, t, r) {
              var n,
                ...
                p = "",
                v = [],
                g = { val: r(0), position: t, index: 1 };
              for (n = 0; n < 3; n += 1) l[n] = n;
              for (o = 0, s = Math.pow(2, 2), u = 1; u != s; )
                (a = g.val & g.position),
                  (g.position >>= 1),
                  0 == g[_0x4475("0x68")] &&
                    ((g.position = t), (g.val = r(g.index++))),
                  (o |= (0 < a ? 1 : 0) * u),
                  (u <<= 1);
              switch (o) {
                case 0:
              ...
              for (i = l[3] = c, v.push(c); ; ) {
                if (g.index > e) return "";
                for (o = 0, s = Math[_0x4475("0x61")](2, d), u = 1; u != s; )
                  (a = g.val & g.position),
                    (g.position >>= 1),
                    0 == g.position &&
                      ((g.position = t), (g.val = r(g.index++))),
                  ...
                  case 0:
                    for (o = 0, s = Math.pow(2, 8), u = 1; u != s; )
                      (a = g.val & g.position),
                        (g.position >>= 1),
                        0 == g.position &&
                          ((g[_0x4475("0x68")] = t), (g.val = r(g.index++))),
                        (o |= (0 < a ? 1 : 0) * u),
                        (u <<= 1);
                    (l[f++] = y(o)), (c = f - 1), h--;
                    break;
      ...
      void 0 ===
        (n = function () {
          return i;
        }[_0x4475("0x49")](t, r, t, e)) || (e.exports = n);
    },
  ]);
});
